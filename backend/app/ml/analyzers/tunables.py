...
TUNABLES: dict[str, list[Tunable]] = {
    ...
    "LegExtensionAnalyzer": [
        Tunable("knee_rest", "Vị trí nghỉ — góc gối dưới mức này là chân đang gập",
                80.0, 50.0, 110.0, affects_rep_count=True),
        Tunable("knee_extended", "Đã duỗi đủ — vượt góc này là chân đã duỗi thẳng hết cỡ",
    ...
    "PulldownAnalyzer": [
        Tunable("elbow_contracted", "Kéo hết — khuỷu gập dưới góc này mới tính một rep",
                90.0, 30.0, 130.0, affects_rep_count=True),
    ...
    "TricepExtensionAnalyzer": [
        Tunable("elbow_bent", "Vị trí bắt đầu — khuỷu gập dưới góc này là tạ ở gần vai/sau đầu",
                90.0, 40.0, 130.0, affects_rep_count=True),
        Tunable("elbow_extended", "Đã duỗi thẳng — vượt góc này là đã duỗi hết tay",
                160.0, 120.0, 180.0, affects_rep_count=True),
    ...
    "CrunchAnalyzer": [
        Tunable("hip_contracted", "Gập hết — góc vai-hông-gối dưới mức này mới tính một rep",
                110.0, 60.0, 150.0, affects_rep_count=True),
        Tunable("hip_extended", "Về vị trí bắt đầu — vượt góc này là thân/chân đã duỗi thẳng",
                165.0, 130.0, 180.0, affects_rep_count=True),
    ],
    "HipAbductionAnalyzer": [
        Tunable("hip_abducted", "Dạng hết — góc vai-hông-gối dưới mức này mới tính một rep",
    ...
    "FacePullAnalyzer": [
        ...
        Tunable("elbow_extended", "Về vị trí bắt đầu — vượt góc này là tay đã duỗi gần thẳng",
                155.0, 110.0, 180.0, affects_rep_count=True),
        Tunable("elbow_asymmetry", "Lệch hai tay — chênh quá góc này là kéo lệch bên",
                25.0, 5.0, 60.0),
    ],
}
