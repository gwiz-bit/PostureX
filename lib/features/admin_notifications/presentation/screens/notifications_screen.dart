...
import '../../admin_notifications_module.dart';
...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final history = await AdminNotificationsModule.getBroadcastHistory()();
      if (!mounted) return;
  ...
  Future<void> _send() async {
    ...
    try {
      final recipients = await AdminNotificationsModule.sendBroadcast()(
        title: title,
