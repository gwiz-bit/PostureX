...
import '../../admin_users_module.dart';
...
class _UserDetailScreenState extends State<UserDetailScreen> {
  ...
  Future<void> _toggleActive() async {
    ...
    if (!ok) return;
    await _runUpdate(() => AdminUsersModule.updateAdminUser()(_user.id, isActive: targetActive));
  }
  ...
  Future<void> _toggleAdmin() async {
    ...
    if (!ok) return;
    await _runUpdate(() => AdminUsersModule.updateAdminUser()(_user.id, isAdmin: targetAdmin));
  }
  ...
  Future<void> _delete() async {
    ...
    setState(() => _isBusy = true);
    try {
      await AdminUsersModule.deleteAdminUser()(_user.id);
      if (!mounted) return;
