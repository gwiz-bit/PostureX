...
import '../../admin_revenue_module.dart';
...
class _RevenueScreenState extends State<RevenueScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final stats = await AdminRevenueModule.getAdminRevenue()();
      if (!mounted) return;
                        ...
                        children: [
                          Row(children: [
                            Expanded(
                                child: MetricCard(
                                    label: 'Total revenue',
                                    value: _money(stats.totalRevenue, stats.currency))),
                              ...
                              rows: stats.byPlan.map((p) {
                                return Padding(
                                  ...
                                  child: Row(children: [
                                    ...
                                    Text(_money(p.revenue, stats.currency),
                                        style: const TextStyle(
                                            fontSize: 13, fontWeight: FontWeight.w600, color: kInk)),
                                  ]),
                                );
